...
var (
	pkg       = flag.String("assert-path", "github.com/stretchr/testify/lite/assert", "Path to the assert package")
...
var headerTemplate = `// Code generated with github.com/stretchr/testify/lite/_codegen; DO NOT EDIT.
